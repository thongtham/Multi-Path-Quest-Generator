...
startQuestPath(GC,GL,AC,AL,AR,LA,P,PF)
:-
	member(GC,AC),
...
:-	
	...
	% -------------------------- Write to file -----------------------------
	atom_concat('file',LC,NAME),
	atom_concat(NAME,'.txt',NAME2),
	
    open(NAME2,write, Stream),
    (  	writeln(PF),
    	writeln(Stream,AC), 
		writeln(Stream,AL),
		writeln(AR)
...
:-
	...
	(resolving(GC,GL,AC,AL,AR,LA,P,LC,ACRS_2,ALRS_2,ARRS_2,LA_2,P_2,LC_2) -> questPathMainLoop_React(GC,GL,ACRS_2,ALRS_2,ARRS_2,LA_2,P_2,LC_2,ACRS_B,ALRS_B,ARRS_B,PRS_B,LCRS_B)
	;ACRS = AC,
	ALRS = AL,
	ARRS = AR,
	LARS = LA,
...
questPathMainLoop_React(GC,GL,AC,AL,AR,LA,P,LC,ACRS,ALRS,ARRS,LARS,PRS,LCRS)
:-
	%If it's possible to resolve, loop until no longer possible to resolve
	(reacting(GC,GL,AC,AL,AR,LA,P,LC,ACRS_2,ALRS_2,ARRS_2,LA_2,P_2,LC_2) -> questPathMainLoop_React(GC,GL,ACRS_2,ALRS_2,ARRS_2,LA_2,P_2,LC_2,ACRS_B,ALRS_B,ARRS_B,PRS_B,LCRS_B)
	;questPathMainLoop_Resolve(GC,GL,AC,AL,AR,LA,P,LC,ACRS,ALRS,ARRS,LARS,PRS,LCRS)
	).
...
resolving(GC,GL,AC,AL,AR,[],P,LC,ACRS,ALRS,ARRS,LARS,PRS,LCRS)
:-
	false.
...
reacting(GC,GL,AC,AL,AR,LA,P,LC,ACRS,ALRS,ARRS,LARS,PRS,LCRS)
:-
	...
	existCharListSkillFromList(AC,CharB,cure), %can char2 cure poison?
