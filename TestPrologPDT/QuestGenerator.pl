...
%testQuestGameState(kill,character(jack,15,alive,weak,market),startQuest).
...
testQuestGameState(kill,Goal,Path) :-
	...
	testGameStateKillQuest(AllItem,AllCharacter,AllRelation,AllAttribute,Goal,Path2,LoopCounter).	

	
testQuestGameState(AllItem,AllCharacter,AllRelation,AllAttribute,kill,Goal,Path,LoopCounter) :-
	append([kill_quest],[Path],Path2),
	member(Goal,AllCharacter),
	LoopCounter = 1,
	protocol('C:/Users/user/Desktop/Prolog Test/TextPrintFromProlog/filePath.txt'),
	write('[Start Quest Analyzing Test, kill component]'),
	noprotocol,
...
testQuestGameState(heal,Goal,Path) :-
	...
	member(Goal,AllCharacter),
	LoopCounter = 1,
	testGameStateHeal(AllItem,AllCharacter,AllRelation,AllAttribute,Goal,Path2,LoopCounter).
...
testQuestGameState(give,Goal,Path) :-
	...
	member(Item,AllItem),
	LoopCounter = 1,
	testGameStateGiveQuest(AllItem,AllCharacter,AllRelation,AllAttribute,Goal,Path2,LoopCounter).
...
testGameStateKillQuest(AllItem,AllCharacter,AllRelation,AllAttribute,character(Name,Level,Status,Attribute,Location),Path,LoopCounter) :-
%	write(AllItem),
%	nl,
%	nl,
%	write(AllCharacter),
...
%	nl,
	...
	( 	testGameStateKillQuest1(AllItem,AllCharacter,AllRelation,AllAttribute,character(Name,Level,Status,Attribute,Location),Path,LoopCounter) -> true
	;	testGameStateKillQuest2(AllItem,AllCharacter,AllRelation,AllAttribute,character(Name,Level,Status,Attribute,Location),Path,LoopCounter)
...
testGameStateKillQuest1(AllItem,AllCharacter,AllRelation,AllAttribute,character(Name,Level,Status,Attribute,Location),Path,LoopCounter) :-
	getCharacterFromList(AllCharacter,Name,Char),
	check_character(Char,status,TargetStatus),
	nl,
	write(check_If_Reach_Goal),
	nl,
	TargetStatus == dead,
	nl,
	...
	reverse(Path,RePath,[]),
	open('C:/Users/user/Desktop/Prolog Test/TextPrintFromProlog/filePath.txt', append, Handle), 
	write(Handle,"\\\n"),
	write(Handle, RePath), 
	write(Handle,"\\\n"),
	write(Handle,AllItem),
	write(Handle,"\\\n"),
	write(Handle,AllCharacter),
	write(Handle,"\\\n"),
	write(Handle,AllRelation),
	write(Handle,"\\\n"),
	write(Handle,AllAttribute),
	write(Handle,"\\\n"),
	write(Handle,"\\\n"),
	close(Handle).
...
%%%% Just to reverse the path for chronological happening
reverse([],Z,Z).
...
%Direct_Attack
testGameStateKillQuest2(AllItem,AllCharacter,AllRelation,AllAttribute,character(Name,Level,Status,Attribute,Location),Path,LoopCounter) :-
	write(check_effect_player_attack),
	nl,
	...
	write(check_effect_player_attack_CAN),
	nl,
	append([direct_attack_by],Path,Path2),
	append([player],Path2,Path3),
	write(Path3),
	nl,
	killQuest_Direct_Attack(AllItem,AllCharacter,AllRelation,AllAttribute,character(Name,Level,Status,Attribute,Location),Path3,LoopCounter).
	
	
%Hire_to_Attack
testGameStateKillQuest2(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter) :-
	write(test5),
	nl,
	nl,
	write(AllRelation),
	...
	write(test6),
	nl,
	killQuest_Hire_to_Attack(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),AssassinName,[hire_to_attack_hitman_is|Path],LoopCounter).
...
%	write(test8),
%	killQuest_Bribe_Accusation(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),GuardName,Path,LoopCounter).
...
%%%% 
%%%% 
killQuest_Resolve(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter) :-
	write(resolve_loop),
	nl,
	( 	killQuest_Resolve_loop1(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,AllItemNew,AllCharacterNew,AllRelationNew,AllAttributeNew,character(TargetNameNew,TargetLevelNew,TargetStatusNew,TargetAttributeNew,TargetLocationNew),PathNew,LoopCounter ) ->  killQuest_Resolve(AllItemNew,AllCharacterNew,AllRelationNew,AllAttributeNew,character(TargetNameNew,TargetLevelNew,TargetStatusNew,TargetAttributeNew,TargetLocationNew),PathNew,LoopCounter)
	;	testGameStateKillQuest(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter) 
	).
...
killQuest_Resolve_loop1(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,AllItem,AllCharacterNew,AllRelationNew2,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),PathNew,LoopCounter ) :-
	write(before_hire_resolve),
	nl,
	write(AllRelation),
	...
	nl,
	add_crime(AllRelationNew,murder,AssassinChar,AllRelationNew2),
	write(resolve_hire_to_attack_addcrime), 
	nl,
	write(after_hire_resolve),
	nl,
	PathNew = [resolve_hire_to_attack|Path].
...
%	nl,
%	killQuest_Resolve(AllItem,AllCharacterNew,AllRelationNew2,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path).
...
killQuest_Direct_Attack(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter) :-
%	write(direct_Attack),
%	nl,
	getCharacterFromList(AllCharacter,player,PlayerChar),
...
%	write(AllRelationNew),
%	nl,	
	killQuest_Resolve(AllItem,AllCharacterNew,AllRelationNew,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter).
...
%%%%  
%%%%  
killQuest_Hire_to_Attack(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),AssassinName,Path,LoopCounter) :-
	
	write(kill_Quest_Hire_To_Attack),
	nl,
	nl,
	write(AllItem),
	nl,
...
%	write(TargetChar), 
%	nl,
	killQuest_Hire_to_Attack_Resolve(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),[AssassinName|Path],PlayerChar,AssassinChar,TargetChar,LoopCounter).

	
%% SUB 
%% RESOLVE HIRE TO ATTACK
%%
killQuest_Hire_to_Attack_Resolve(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,PlayerChar,AssassinChar,TargetChar,LoopCounter) :-
%	direct_attack_record(AllCharacter,AssassinChar,TargetChar,AllCharacterNew),
%	write(hire_to_attack_record), 
%	nl,
...
%	nl,
	...
	list_item_asserted(AllRelation,relationship(hire_to_attack,PlayerChar,AssassinChar,TargetChar), AllRelationNew),
	killQuest_Resolve(AllItem,AllCharacterNew,AllRelationNew,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter).
...
%%%%  f
%%%%  f
killQuest_Bribe_Accusation(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),CorruptGuardName,Path,LoopCounter) :-
	getCharacterFromList(AllCharacter,player,PlayerChar),
	getCharacterFromList(AllCharacter,CorruptGuardName,CorruptGuardChar),
	getCharacterFromList(AllCharacter,TargetName,TargetChar),
	killQuest_Bribe_Accusation_Resolve(AllItem,AllCharacter,AllRelation,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,PlayerChar,CorruptGuardChar,TargetChar,LoopCounter).
...
%%
	...
	%
	%
	testGameStateKillQuest(AllItem,AllCharacterNew,AllRelationNew,AllAttribute,character(TargetName,TargetLevel,TargetStatus,TargetAttribute,TargetLocation),Path,LoopCounter).
...
gameStateAbility(AllAbility)	:-	 findall(ability(Name1,Ability1), (ability(Name1,Ability1)), AllAbility).

gameStateOccupation(AllOcupation) :- findall(occupation(Name1,Occupation1), (occupation(Name1,Occupation1)), AllOcupation).
...
%%% Also be used to store 'memory' such as [relationship(hire_to_kill,Client,Victim)]
...
%%% RELATIONSHIP/4
%%% pending for resolve
%%% *Only use in prolog, should not be stored in Java.

relationship(hire_to_attack,ClientChar,AssassinChar,TargetChar).
relationship(bribe_to_crime,ClientChar,Police,TargetChar).
